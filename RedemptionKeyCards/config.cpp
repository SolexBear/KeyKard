	...
	class RedemptionKeyCards
	{
		...
		class defs
		{
			class worldScriptModule
			{
				...
				files[]=
				{
					"RedemptionKeyCards/Scripts/4_World"
				};
			};
		};
	};
...
class CfgVehicles
{
	...
	{
		scope=2;
		displayName="Karta Level 01";
		descriptionShort="Karta dostępu POZIOMU 01";
		hiddenSelectionsTextures[]=
		{
			"RedemptionKeyCards\Data\Textures\KeyCard\keycard01_co.paa"
		};
	};
	class RedemptionKeyCard_02: RedemptionKeyCard_Base
	{
		scope=2;
		displayName="Karta Level 02";
		descriptionShort="Karta dostępu POZIOMU 02";
		hiddenSelectionsTextures[]=
		{
			"RedemptionKeyCards\Data\Textures\KeyCard\keycard02_co.paa"
		};
	};
	class RedemptionKeyCard_03: RedemptionKeyCard_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"RedemptionKeyCards\Data\Textures\KeyCard\keycard03_co.paa"
		};
	};
	class RedemptionKeyCard_04: RedemptionKeyCard_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"RedemptionKeyCards\Data\Textures\KeyCard\keycard04_co.paa"
		};
	};
	...
	class RedemptionMilitaryCrate: RedemptionMilitaryCrate_Base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"RedemptionKeyCards\Data\Textures\Crate\crate_co.paa"
		};
	};
};
